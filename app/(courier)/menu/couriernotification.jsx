    ...
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      >
        {loading ? (
          ...
          <Text style={[styles.emptyText, { color: colors.subText }]}>No reports found.</Text>
        ) : (
          notifications.map((item) => (
            <View key={item.userreporting_id} style={[styles.notifcontainer, { backgroundColor: colors.card }]}>
              ...
              <View style={styles.notifdescription}>
                <Text style={{ color: colors.subText, marginBottom: 5, fontSize: 13 }}>
                ...
                {item.appeal_reason && (
                  <View style={styles.appealBox}>
                    ...
                    <Text style={[styles.appealText, { color: colors.subText }]}>"{item.appeal_reason}"</Text>
                  </View>
                )}
              </View>
            </View>
