...
export default function OrderHistory() {
  ...
  const renderOrderCard = ({ item }) => {
    ...
    return (
      <View style={[styles.ordercard, showReservedBadge && { borderColor: '#0AB3FF' }]}>
        ...
        <View style={styles.orderinfo}>
          ...
          <View style={styles.footerRow}>
            <View style={styles.metaContainer}>
                ...
                <View style={styles.metaRow}>
                    <Image source={time} style={[styles.metaIcon, showReservedBadge && { tintColor: '#0AB3FF' }]}/>
                    <Text style={[styles.metaText, showReservedBadge && { color: '#0AB3FF', fontWeight: 'bold' }]} numberOfLines={1}>
                        {dateStr}
                    </Text>
                </View>
            </View>
            ...
            <View style={styles.actionButtons}>
                <Pressable onPress={() => toggleFavorite(item.order_id)} style={styles.heartButton}>
                    <Image source={heartIcon} style={[styles.heartIcon, { tintColor: isFavorited ? '#FF4444' : '#8796AA' }]}/>
                </Pressable>

                <Pressable style={[styles.viewButton, showReservedBadge && { backgroundColor: '#0AB3FF' }]} onPress={() => handleViewOrder(item)}>
  ...
  const renderFooter = () => {
    ...
    return <View style={{ paddingVertical: 20 }}><ActivityIndicator size="small" color="#0AB3FF" /></View>;
  };
...
const styles = StyleSheet.create({
  ...
  filtercontainer:{ backgroundColor:'#363D47', borderColor:'#363D47', borderWidth:1, borderRadius:11, width:'100%', height:'auto', marginTop: verticalScale(20), padding: 5, flexDirection: 'row', alignItems: 'center', gap: 10, zIndex: 2000 },
  ...
  dropdownContainer: { backgroundColor: '#22262F', borderColor: '#4B5563', borderWidth: 1, borderRadius: 8, marginTop: 5, maxHeight: 300 },
  ...
  ordercard:{ width:'100%', backgroundColor:'#363D47', borderRadius:14, marginBottom: 15, padding: 16, borderWidth: 1, borderColor: '#4B5563', position: 'relative' },
  orderinfo:{ flexDirection:'column' },
  scheduledBadge: { position: 'absolute', top: 10, right: 10, backgroundColor: '#0AB3FF', flexDirection: 'row', alignItems: 'center', paddingHorizontal: 8, paddingVertical: 4, borderRadius: 6, zIndex: 10 },
  badgeIcon: { width: 10, height: 10, tintColor: 'black', marginRight: 4 },
  badgeText: { fontSize: 10, fontWeight: 'bold', color: 'black' },
  productRow:{ flexDirection:'row', justifyContent:'space-between', alignItems:'center', marginBottom:12, paddingRight: 60 },
  ...
  viewButton:{ backgroundColor:'#3BF579', borderRadius: 8, paddingVertical: 8, paddingHorizontal: 20, justifyContent:'center', alignItems:'center', elevation: 2 },
