    ...
    <View style={[styles.container, { backgroundColor }]}>
      ...
      <View style={styles.mainContent}>
        ...
        <View style={styles.tableheader}>
          <View><Text style={[styles.tableheadertext, { color: textColor }]}>Courier Table</Text></View>
        ...
        <View style={[styles.tableContainer, { backgroundColor: cardColor }]}>
          <DataTable>
            <DataTable.Header style={[styles.tableHeader, { backgroundColor: cardColor, borderBottomColor: borderColor }]}>
              ...
              <DataTable.Title style={styles.vehicleColumn} textStyle={[styles.headerText, { color: textColor }]}>Vehicle</DataTable.Title>
            ...
            {loading ? (
              ...
              couriers.map((courier) => {
                ...
                return (
                  <DataTable.Row key={courier.user_id} style={[styles.row, { borderBottomColor: borderColor }]}>
                    <DataTable.Cell style={styles.idColumn} textStyle={[styles.cellText, { color: textColor }]}>{courier.user_id.substring(0, 6)}...</DataTable.Cell>
                    <DataTable.Cell style={styles.nameColumn} textStyle={[styles.cellText, { color: textColor }]}>{fullName}</DataTable.Cell>
                    <DataTable.Cell style={styles.vehicleColumn} textStyle={[styles.cellText, { color: textColor }]}>{courier.vehicle}</DataTable.Cell>
                    ...
                    <DataTable.Cell style={styles.actionsColumn}>
                      <Menu
                        ...
                        onDismiss={closeMenu}
                        anchor={<IconButton icon="dots-vertical" iconColor={tintColor} size={20} onPress={() => openMenu(courier.user_id)} />}>
            ...
            <View style={[styles.modalView, { backgroundColor: cardColor }]}>
              ...
              <View style={{ width: '100%', marginBottom: 15, zIndex: 3000 }}>
                ...
                <DropDownPicker
                  ...
                  zIndex={3000}
                  style={[styles.dropdown1, { backgroundColor: backgroundColor === '#141519' ? '#22262F' : '#F3F4F6', borderColor: borderColor }]}
              ...
              <View style={{ width: '100%', marginBottom: 20 }}>
                ...
                <TextInput
                  style={[styles.reasonInput, { backgroundColor: backgroundColor === '#141519' ? '#22262F' : '#F3F4F6', color: textColor }]}
              ...
              <View style={styles.modalButtons}>
                <Pressable style={[styles.cancelButton, { borderColor: textColor }]} onPress={() => setModalVisible(false)}>
        ...
        <Modal
          ...
          <View style={styles.centeredView}>
            <View style={[styles.modalView, { backgroundColor: cardColor }]}>
              ...
              <View style={{ width: '100%', marginBottom: 20 }}>
                <Text style={{ color: subTextColor, marginBottom: 8 }}>Reason for Rejection:</Text>
                <TextInput
                  style={[styles.reasonInput, { backgroundColor: backgroundColor === '#141519' ? '#22262F' : '#F3F4F6', color: textColor }]}
              ...
              <View style={styles.modalButtons}>
                <Pressable style={[styles.cancelButton, { borderColor: textColor }]} onPress={() => setRejectModalVisible(false)}>
                  <Text style={[styles.buttonText, { color: textColor }]}>Cancel</Text>
                </Pressable>
          ...
          <View style={styles.centeredView}>
            <View style={[styles.modalView, { backgroundColor: cardColor }]}>
              <View style={{ flexDirection: 'row', marginBottom: 16 }}>
                ...
                <Text style={[styles.modalTitle, { color: textColor }]}>Approve Application?</Text>
              </View>
              ...
              <View style={styles.modalButtons}>
                <Pressable style={[styles.cancelButton, { borderColor: textColor }]} onPress={() => setApproveModalVisible(false)}>
                  <Text style={[styles.buttonText, { color: textColor }]}>Cancel</Text>
                </Pressable>
